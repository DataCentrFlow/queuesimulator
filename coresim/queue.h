...
class Queue {
    public:
        ...
        void registerInsert(Packet* p);
        void dropLeft();

        void unimplemented();
        virtual void enque(Packet *packet);
        virtual Packet *extractPacket(Packet *packet);
        virtual long long estimate(Packet* packet);
        virtual int comparePackets(Packet* p1, Packet* p2);
